import s from "./newPasswordWithoutToken.module.css";
import React from "react";

export const NewPasswordWithoutToken = () => {
    return (
        <div className={s.mainContainer}>
            <div className={s.redirectMessage}>
                <div className={s.string}>
                Go to <a href={'/restore-password'}>'restore password'<svg viewBox="0 0 70 36">
            ...
            </svg></a> page first and insert your e-mail
                </div>
            </div>
        </div>
    )
